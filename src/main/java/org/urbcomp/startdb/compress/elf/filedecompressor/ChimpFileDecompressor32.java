...
import org.urbcomp.startdb.compress.elf.decompressor32.ElfDecompressor32;
...
public class ChimpFileDecompressor32 extends AbstractFileDecompressor{
    @Override
    public void decompress() throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(this.getOutputFilePath(), true))) {
            ...
            for (byte[] block : data) {
                IDecompressor32 decompressor = new ChimpDecompressor32(block);
