...
public class SElfStarFileCompressor extends AbstractFileCompressor {
    private int col_num;
    @Override
    public void compress() throws IOException {
        ...
        try(FileOutputStream fos = new FileOutputStream(this.getOutputFilePath())){
            ...
            fos.write(ByteInt.intToBytes(10));
            if ("csv".equals(fileExtension) || "txt".equals(fileExtension)){
                ...
                while ((vs = fileReader.nextBlock()) != null) {
                    ICompressor compressor = new SElfStarCompressor(new SElfStarXORCompressor(100));
                    for (double v : vs) {
